 ...
 * «корень = воркспейс» (preview route в `server/index.mjs`): без него путь резолвится
 ...
 * — `safeWorkspacePath` в `server/native/security.mjs` (I-02), и она закрыта тестом. Клиент,
