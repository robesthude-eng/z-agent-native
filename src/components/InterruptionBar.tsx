 ...
 *
 * Прежний `PermissionDialog` с подробными текстами удалён: его кнопки не
 * доходили до сервера, а две копии одних и тех же формулировок молча
 * расходились. Осталась одна короткая форма — здесь.
 */
...
export default function InterruptionBar() {
   ...
   * прежний диалог разрешений, и потерять это при переезде значило бы
   * починить одно (вопрос уходил прокруткой) ценой другого: с клавиатуры
   * до полосы,
